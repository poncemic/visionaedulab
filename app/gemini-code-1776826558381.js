  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      <header className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-100 to-white px-6 py-20">
        <div className="max-w-7xl mx-auto w-full animate-in fade-in duration-1000">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-16">
            ...
            <div className="order-1 lg:order-2 lg:w-1/3 flex justify-center">
              <div className="relative hover:scale-105 transition-transform duration-500 transition-shadow">
                 <img 
                  src="/Visiona Edu Lab_20 Abril JPG.jpg" 
                  alt="Visiona EduLab" 
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-extrabold text-[#002147] leading-tight mb-8">
              Expandiendo los límites de la <span className="text-[#50C878]">educación</span> <br className="hidden md:block" />
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-xl flex flex-col md:flex-row items-center gap-10 border border-slate-100">
            <div className="w-48 h-48 md:w-64 md:h-64 flex-shrink-0 overflow-hidden rounded-3xl shadow-lg">
              <img src="/WhatsApp Image 2026-04-21 at 23.05.23.jpeg" alt="Miguel Ponce" className="w-full h-full object-cover" />
            </div>
      ...
      <section id="adn" className="py-24 px-6 bg-[#002147] text-white rounded-[3rem] mx-4 shadow-2xl">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-12 text-center">
          ...
          <div className="p-8 border border-white/10 rounded-3xl bg-white/5">
            <h4 class="text-2xl font-bold mb-4 text-[#FF8C00]">EDU</h4>
            <p class="text-slate-300 italic">Agilidad EdTech. Un enfoque moderno y tecnológico para el aprendizaje dinámico.</p>
          </div>
          <div class="p-8 border border-white/10 rounded-3xl bg-white/5">
            <h4 class="text-2xl font-bold mb-4 text-white">LAB</h4>
            <p class="text-slate-300 italic">I+D Pedagógico. Espacio de experimentación donde se co-crea el conocimiento.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
                ...
                <a href="/Visiona_EduLab_Dossier_Institucional_2026.docx" download className="inline-block bg-[#002147] text-white px-8 py-4 rounded-xl font-bold hover:bg-slate-800 transition">
      ...
      <footer className="py-16 px-6 text-center border-t border-slate-100 bg-slate-50">
        <img src="/Visiona Edu Lab_20 Abril JPG.jpg" alt="Logo" className="h-12 mx-auto mb-6 opacity-60 grayscale" />
